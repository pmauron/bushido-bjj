...
/* ━━━ ROSTER SCREEN ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ */
function RosterScreen({ roster, setRoster, config, setConfig, assessments, setAssessments, defaultGym, isAdmin, isCommunity, selections, attendance, selectedKidId, setSelectedKidId, onEditAssessment }) {
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8, flexWrap: "wrap" }}>
          ...
          {kid && <button style={s.btnSm} onClick={() => {
            ...
            const promoData = (() => {
              ...
              // Hide "Time at belt" gate if no real promotion date on record
              const hasRealPromoDate = kid.lastPromotionDate && kid.lastPromotionDate !== "2020-01-01";
              const gates = hasRealPromoDate ? p.gates : p.gates.filter(g => g.label !== "Time at belt");
              return { ...p, gates, targetDt, displayDt };
            })();
