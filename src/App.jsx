...
function SettingsScreen({ config, setConfig, roster, assessments, setRoster, setAssessments, setSelections, setAttendance, isAdmin }) {
  ...
  const DEMO_SCHEDULE = [
    {id:"ds01",gym:DEMO_GYM,day:1,time:"10:00",durationMin:60,classTypeId:"demo-fund",coach:DEMO_COACH,capacity:20},
    {id:"ds02",gym:DEMO_GYM,day:3,time:"10:00",durationMin:60,classTypeId:"demo-fund",coach:DEMO_COACH,capacity:20},
    {id:"ds03",gym:DEMO_GYM,day:5,time:"10:00",durationMin:60,classTypeId:"demo-fund",coach:DEMO_COACH,capacity:20},
    {id:"ds04",gym:DEMO_GYM,day:3,time:"12:00",durationMin:90,classTypeId:"demo-adv",coach:DEMO_COACH,capacity:20},
    {id:"ds05",gym:DEMO_GYM,day:6,time:"09:00",durationMin:60,classTypeId:"demo-fund",coach:DEMO_COACH,capacity:20},
    {id:"ds06",gym:DEMO_GYM,day:6,time:"10:30",durationMin:90,classTypeId:"demo-adv",coach:DEMO_COACH,capacity:20},
    {id:"ds07",gym:DEMO_GYM,day:3,time:"14:00",durationMin:90,classTypeId:"comp",coach:DEMO_COACH,capacity:20},
    {id:"ds08",gym:DEMO_GYM,day:6,time:"14:00",durationMin:90,classTypeId:"comp",coach:DEMO_COACH,capacity:20},
  ];
  const loadDemoData = () => {
