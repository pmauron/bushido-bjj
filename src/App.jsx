    ...
    <div style={s.page}>
      ...
      {isAdmin && (
        <div style={{ marginBottom: 12 }}>
          <select value={gymFilter} onChange={e => setGymFilter(e.target.value)} style={{ background: C.card2, border: `1px solid ${C.border}`, borderRadius: 6, color: C.text, padding: "6px 10px", fontSize: 12 }}>
