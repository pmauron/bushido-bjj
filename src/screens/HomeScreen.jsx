...
export function HomeScreen({ roster, attendance, assessments, config, selections, loggedCoach, loggedGym, isAdmin, isCommunity, pendingCount, pendingRegCount, events, onNavigate, onEventClick }) {
            ...
            {upcomingEvents.map((event, i) => {
              ...
              return (
                <div
                  ...
                  style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 14px", borderBottom: i < upcomingEvents.length - 1 ? `1px solid ${C.border}` : "none", cursor: "pointer" }}
                >
